# The Gabber Enterprise License (the “Enterprise License”)

Copyright (c) 2025-present Fluently AI, Inc. DBA Gabber.

With regard to the Gabber Software:

This software and associated documentation files (the "Software") may only be used in production, if
you (and any entity that you represent) hold a valid Gabber Enterprise license corresponding to your
usage. Subject to the foregoing sentence, you are free to modify this Software and publish patches
to the Software. You agree that Gabber and/or its licensors (as applicable) retain all right, title and
interest in and to all such modifications and/or patches, and all such modifications and/or patches
may only be used, copied, modified, displayed, distributed, or otherwise exploited with a valid Gabber
...
agree that Gabber and/or its licensors (as applicable) retain all right, title and interest in and to
...
For all third party components incorporated into the Gabber Software, those components are licensed
