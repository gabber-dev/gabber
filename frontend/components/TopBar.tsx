  ...
  return (
    <div className="flex items-center justify-between bg-base-200 h-full w-full px-4">
      <div className="flex items-center gap-4">
        ...
        <Link
          href={`/example`}
          className="btn btn-sm btn-primary gap-2 normal-case font-semibold hover:scale-105 transition-transform duration-200 rounded-xs"
        >
      ...
      <Link
        ...
        className="btn btn-sm btn-ghost gap-2 normal-case border border-base-300 hover:border-base-content/20 rounded-xs"
      >
