 ...
 */
export type Request = SaveSubgraphRequest | SaveAppRequest;
 ...
 */
export type Response = SaveSubgraphResponse | SaveAppResponse | ListAppsResponse | ListTemplatesResponse;
export type Type25 = "save_subgraph_response";
export type Id5 = string;
export type Name3 = string;
export type CreatedAt1 = string;
export type UpdatedAt1 = string;
export type Type26 = "save_app_response";
export type Id6 = string;
export type Name4 = string;
export type CreatedAt2 = string;
export type UpdatedAt2 = string;
export type Type27 = "list_apps_response";
export type Apps = RepositoryApp[];
export type Type28 = "list_templates_response";
export type Templates = RepositoryApp[];
