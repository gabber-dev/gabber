...
#   timestamp: 2025-12-01T04:43:44+00:00
...
class ToolDefinitionDestinationWebhookRetryPolicy(BaseModel):
    max_retries: Annotated[Optional[int], Field(title='Max Retries')] = 3
    backoff_factor: Annotated[Optional[float], Field(title='Backoff Factor')] = 2.0
    initial_delay_seconds: Annotated[
        Optional[float], Field(title='Initial Delay Seconds')
    ] = 1.0
