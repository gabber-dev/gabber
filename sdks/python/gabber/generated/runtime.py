...
#   timestamp: 2025-12-11T20:38:24+00:00
...
class ToolCall(BaseModel):
    call_id: Annotated[str, Field(title='Call Id')]
    index: Annotated[int, Field(title='Index')]
    name: Annotated[str, Field(title='Name')]
    arguments: Annotated[dict[str, Any], Field(title='Arguments')]


class ToolCallResponsePayloadInitiateAck(BaseModel):
    type: Annotated[Literal['initiate_ack'], Field(title='Type')] = 'initiate_ack'
    call_id: Annotated[str, Field(title='Call Id')]


class ToolCallResponsePayloadResult(BaseModel):
    type: Annotated[Literal['result'], Field(title='Type')] = 'result'
    call_id: Annotated[str, Field(title='Call Id')]
    result: Annotated[Optional[str], Field(title='Result')] = None
    error: Annotated[Optional[str], Field(title='Error')] = None


class ToolDefinitionDestinationClient(BaseModel):
    type: Annotated[Literal['client'], Field(title='Type')] = 'client'


class ToolDefinitionDestinationWebhookRetryPolicy(BaseModel):
    max_retries: Annotated[int, Field(title='Max Retries')]
    backoff_factor: Annotated[float, Field(title='Backoff Factor')]
    initial_delay_seconds: Annotated[float, Field(title='Initial Delay Seconds')]
...
class GabberCoreTypesClientViseme(BaseModel):
    type: Annotated[Literal['viseme'], Field(title='Type')] = 'viseme'
    value: VisemeEnum
...
class GabberCoreTypesPadConstraintsViseme(BaseModel):
    type: Annotated[Literal['viseme'], Field(title='Type')] = 'viseme'
...
class ToolCallResponse(BaseModel):
    type: Annotated[Literal['tool_call_response'], Field(title='Type')] = (
        'tool_call_response'
    )
    payload: Annotated[
        Union[ToolCallResponsePayloadInitiateAck, ToolCallResponsePayloadResult],
        Field(
...
class ToolDefinitionDestinationWebhook(BaseModel):
    type: Annotated[Literal['webhook'], Field(title='Type')] = 'webhook'
    url: Annotated[str, Field(title='Url')]
    retry_policy: ToolDefinitionDestinationWebhookRetryPolicy


class GabberCoreTypesClientContextMessage(BaseModel):
    type: Annotated[Literal['context_message'], Field(title='Type')] = 'context_message'
    role: GabberCoreTypesClientContextMessageRole
    tool_calls: Annotated[list[ToolCall], Field(title='Tool Calls')]
    tool_call_id: Annotated[Optional[str], Field(title='Tool Call Id')] = None
    refusal: Annotated[Optional[str], Field(title='Refusal')] = None
...
class ToolDefinition(BaseModel):
    ...
    destination: Annotated[
        Union[ToolDefinitionDestinationClient, ToolDefinitionDestinationWebhook],
        Field(discriminator='type', title='Destination'),
    ]
...
class ToolCallRequestPayloadInitiateRequest(BaseModel):
    type: Annotated[Literal['initiate_request'], Field(title='Type')] = (
        'initiate_request'
    )
...
class ToolCallRequest(BaseModel):
    type: Annotated[Literal['tool_call_request'], Field(title='Type')] = (
        'tool_call_request'
    )
    payload: Annotated[
        ToolCallRequestPayloadInitiateRequest,
        Field(
            description='Request for a tool call', discriminator='type', title='Payload'
        ),
    ]
...
class DummyType(BaseModel):
    ...
    pad_constraint: Annotated[
        Union[
            ...
            GabberCoreTypesPadConstraintsViseme,
        ],
